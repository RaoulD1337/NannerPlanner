const perkData = {
	...
	perks : [
	  ...
	  */
	  ...
	  //1
	  {name : "Alchemical Lore", skill : 0, skillReq : 0,
	   xPos : 50, yPos : 90, conTo : [0], preReqs : [0], nextPerk: -1,
	  ...
	  {name : "Improved Elixirs", skill : 0, skillReq : 25,
	   xPos : 75, yPos : 85, conTo : [0], preReqs : [0], nextPerk: -1,
	  ...
	  xPos : 60, yPos : 75, conTo : [2], preReqs : [2], nextPerk: -1,	
	  ...
	  xPos : 25, yPos : 85, conTo : [0], preReqs : [0], nextPerk: -1,
	  ...
	  {name : "Addict's Panacea", skill : 0, skillReq : 40,
	   xPos : 40, yPos : 75, conTo : [4], preReqs : [4], nextPerk: -1,
	  ...
	  {name : "Regeneration", skill : 0, skillReq : 65,
	   xPos : 50, yPos : 60, conTo : [2], preReqs : [2], nextPerk: -1,
	  ...
	  {name : "Catalysis", skill : 0, skillReq : 50,
	   xPos : 63, yPos : 35, conTo : [2], preReqs : [2], nextPerk: 8,
	  ...
	  {name : "Improved Poisons", skill : 0, skillReq : 50,
	   xPos : 37, yPos : 35, conTo : [4], preReqs : [4], nextPerk: -1,
	  ...
	  {name : "Immunization", skill : 0, skillReq : 75,
	   xPos : 50, yPos : 25, conTo : [7,9], preReqs : [0], nextPerk: -1,
	  ...
	  {name : "Fortified<br>Muscles", skill : 0, skillReq : 80,
	   xPos : 42, yPos : 47, conTo : [10], preReqs : [10], nextPerk: -1,
	  ...
	  {name : "Alchemical<br>Intellect", skill : 0, skillReq : 100,
	   xPos : 58, yPos : 47, conTo : [10], preReqs : [10], nextPerk: -1,
	  ...
	  {name : "Purification Process", skill : 0, skillReq : 100,
	   xPos : 50, yPos : 5, conTo : [10], preReqs : [10], nextPerk: -1,
	  ...
	  {name : "Apprentice<br>Alteration", skill : 1, skillReq : 25,
	   xPos : 53, yPos : 55, conTo : [14], preReqs : [14], nextPerk: -1,
	  ...
	  {name : "Adept Alteration", skill : 1, skillReq : 50,
	   xPos : 54, yPos : 35, conTo : [15], preReqs : [15], nextPerk: -1,
	  ...
	  {name : "Expert<br>Alteration", skill : 1, skillReq : 75,
	   xPos : 60, yPos : 20, conTo : [16], preReqs : [16], nextPerk: -1,
	  ...
	  {name : "Master Alteration", skill : 1, skillReq : 100,
	   xPos : 70, yPos : 5, conTo : [17], preReqs : [17], nextPerk: -1,
	  ...
	  {name : "Spell Armor", skill : 1, skillReq : 75,
	   xPos : 80, yPos : 20, conTo : [17], preReqs : [17], nextPerk: -1,
	  ...
	  {name : "Magical<br>Absorption", skill : 1, skillReq : 100,
	   xPos : 50, yPos : 7, conTo : [17], preReqs : [17], nextPerk: -1,
	  ...
	  {name : "Empowered<br>Alterations", skill : 1, skillReq : 25,
	   xPos : 35, yPos : 55, conTo : [14], preReqs : [14], nextPerk: -1,
	  ...
	  {name : "Improved<br>Mage Armor", skill : 1, skillReq : 25,
	   xPos : 35, yPos : 38, conTo : [15], preReqs : [15], nextPerk: -1,
	  ...
	  {name : "Magic<br>Resistance", skill : 1, skillReq : 25,
	   xPos : 72, yPos : 37, conTo : [15], preReqs : [15], nextPerk: -1,
	  ...
	  {name : "Stability", skill : 1, skillReq : 50,
	   xPos : 42, yPos : 22, conTo : [16], preReqs : [16], nextPerk: -1,
	  ...
	  {name : "Metamagical<br>Thesis", skill : 1, skillReq : 75,
	   xPos : 25, yPos : 18, conTo : [24], preReqs : [24], nextPerk: -1,
	  ...
	  {name : "Metamagical<br>Empowerment", skill : 1, skillReq : 100,
	   xPos : 32, yPos : 5, conTo : [25], preReqs : [25], nextPerk: -1,
	  ...
	  {name : "Strong Grip", skill : 2, skillReq : 15,
	   xPos : 17, yPos : 70, conTo : [27], preReqs : [27], nextPerk: -1,
	  ...
	  {name : "Experienced Blocking", skill : 2, skillReq : 30,
	   xPos : 14, yPos : 45, conTo : [28], preReqs : [28], nextPerk: -1,
	   ...
	   xPos : 18, yPos : 32, conTo : [29], preReqs : [29], nextPerk: -1,
	  ...
	  {name : "Elemental Protection", skill : 2, skillReq : 75,
	   xPos : 29, yPos : 22, conTo : [30], preReqs : [30], nextPerk: -1,
	  ...
	  {name : "Powerful Bashes", skill : 2, skillReq : 20,
	   xPos : 89, yPos : 65, conTo : [27], preReqs : [27], nextPerk: -1,
	  ...
	  {name : "Overpowering Bashes", skill : 2, skillReq : 40,
	   xPos : 250/3, yPos : 40, conTo : [32], preReqs : [32], nextPerk: -1,
	  ...
	  {name : "Disarming Bash", skill : 2, skillReq : 65,
	   xPos : 75, yPos : 25, conTo : [33], preReqs : [33], nextPerk: -1,
	  ...
	  {name : "Unstoppable Charge", skill : 2, skillReq : 100,
	   xPos : 55, yPos : 15, conTo : [34,31], preReqs : [27], nextPerk: -1,
	  ...
	  {name : "Apprentice<br>Conjuration", skill : 3, skillReq : 25,
	   xPos : 53, yPos : 60, conTo : [36], preReqs : [36], nextPerk: -1,
	  ...
	  {name : "Adept<br>Conjuration", skill : 3, skillReq : 50,
	   xPos : 52, yPos : 42, conTo : [37], preReqs : [37], nextPerk: -1,
	  ...
	  {name : "Expert<br>Conjuration", skill : 3, skillReq : 75,
	   xPos : 50, yPos : 22, conTo : [38], preReqs : [38], nextPerk: -1,
	  ...
	  {name : "Master<br>Conjuration", skill : 3, skillReq : 100,
	   xPos : 50, yPos : 11, conTo : [39], preReqs : [39], nextPerk: -1,
	   ...
	   xPos : 72, yPos : 70, conTo : [36], preReqs : [36], nextPerk: -1,
	  ...
	  {name : "Mystic<br>Binding", skill : 3, skillReq : 50,
	   xPos : 75, yPos : 40, conTo : [41], preReqs : [41], nextPerk: -1,
	  ...
	  {name : "Mystic<br>Banishment", skill : 3, skillReq : 75,
	   xPos : 73, yPos : 25, conTo : [42], preReqs : [42], nextPerk: -1,
	  ...
	  {name : "Mystic<br>Disruption", skill : 3, skillReq : 90,
	   xPos : 71, yPos : 8, conTo : [43], preReqs : [43], nextPerk: -1,
	  ...
	  {name : "Necromancy", skill : 3, skillReq : 25,
	   xPos : 63, yPos : 54, conTo : [36], preReqs : [36], nextPerk: -1,
	  ...
	  {name : "Ritualism", skill : 3, skillReq : 50,
	   xPos : 62, yPos : 34, conTo : [45], preReqs : [45], nextPerk: -1,
	  ...
	  {name : "Dark<br>Infusion", skill : 3, skillReq : 90,
	   xPos : 60, yPos : 15, conTo : [46], preReqs : [46], nextPerk: -1,
	  ...
	  {name : "Summoner's<br>Insight", skill : 3, skillReq : 25,
	   xPos : 47, yPos : 53, conTo : [36], preReqs : [36], nextPerk: -1,
	  ...
	  {name : "Cognitive<br>Flexibility", skill : 3, skillReq : 50,
	   xPos : 44, yPos : 33, conTo : [48], preReqs : [48], nextPerk: 50,
	  ...
	  {name : "Binding<br>Contract", skill : 3, skillReq : 0,
	   xPos : 43, yPos : 70, conTo : [36], preReqs : [36], nextPerk: -1,
	   description : "You have practiced the mental ability of maintaining two summons at the same time. This power extends to controlling any type of conjured or conceived entity, even outside the school of Conjuration."},
	   //52
	  {name : "Stabilized<br>Binding", skill : 3, skillReq : 25,
	   xPos : 30, yPos : 65, conTo : [36], preReqs : [36], nextPerk: -1,
	  ...
	  {name : "Spiritual<br>Binding", skill : 3, skillReq : 35,
	   xPos : 35, yPos : 48, conTo : [52], preReqs : [52], nextPerk: -1,
	  ...
	  {name : "Extended<br>Binding", skill : 3, skillReq : 50,
	   xPos : 29, yPos : 35, conTo : [52], preReqs : [52], nextPerk: -1,
	  ...
	  {name : "Elemental Binding", skill : 3, skillReq : 75,
	   xPos : 32, yPos : 8, conTo : [54], preReqs : [54], nextPerk: -1,
	  ...
	  {name : "Empowered<br>Elements", skill : 4, skillReq : 20,
	   xPos : 20, yPos : 65, conTo : [56], preReqs : [56], nextPerk: -1,
	  ...
	  {name : "Impact", skill : 4, skillReq : 50,
	   xPos : 21, yPos : 20, conTo : [57], preReqs : [57], nextPerk: -1,
	  ...
	  {name : "Esoteric Magic", skill : 4, skillReq : 40,
	   xPos : 33, yPos : 55, conTo : [56], preReqs : [56], nextPerk: 60,
	  ...
	  {name : "Clandestine<br>Magic", skill : 4, skillReq : 60,
	   xPos : 35, yPos : 25, conTo : [59], preReqs : [59], nextPerk: -1,
	  ...
	  {name : "Forbidden<br>Knowledge", skill : 4, skillReq : 95,
	   xPos : 32, yPos : 5, conTo : [61], preReqs : [61], nextPerk: -1,
	  ...
	  {name : "Apprentice<br>Destruction", skill : 4, skillReq : 25,
	   xPos : 47, yPos : 66, conTo : [56], preReqs : [56], nextPerk: -1,
	  ...
	  {name : "Rune Mastery", skill : 4, skillReq : 50,
	   xPos : 40, yPos : 17, conTo : [63], preReqs : [63], nextPerk: -1,
	  ...
	  {name : "Adept<br>Destruction", skill : 4, skillReq : 50,
	   xPos : 47, yPos : 40, conTo : [63], preReqs : [63], nextPerk: -1,
	  ...
	  {name : "Expert<br>Destruction", skill : 4, skillReq : 75,
	   xPos : 48, yPos : 25, conTo : [65], preReqs : [65], nextPerk: -1,
	  ...
	  {name : "Master<br>Destruction", skill : 4, skillReq : 100,
	   xPos : 46, yPos : 10, conTo : [66], preReqs : [66], nextPerk: -1,
	  ...
	  {name : "Elemental Expertise", skill : 4, skillReq : 25,
	   xPos : 70, yPos : 55, conTo : [56], preReqs : [56], nextPerk: 69,
	  ...
	  {name : "Electrostatic<br>Discharge", skill : 4, skillReq : 75,
	   xPos : 58, yPos : 35, conTo : [68], preReqs : [68], nextPerk: -1,
	  ...
	  {name : "Lightning<br>Mastery", skill : 4, skillReq : 100,
	   xPos : 59, yPos : 12, conTo : [70], preReqs : [70], nextPerk: -1,
	  ...
	  {name : "Deep<br>Freeze", skill : 4, skillReq : 75,
	   xPos : 66, yPos : 35, conTo : [68], preReqs : [68], nextPerk: -1,
	  ...
	  {name : "Frost<br>Mastery", skill : 4, skillReq : 100,
	   xPos : 66, yPos : 12, conTo : [72], preReqs : [72], nextPerk: -1,
	  ...
	  {name : "Cremation", skill : 4, skillReq : 75,
	   xPos : 74, yPos : 36, conTo : [68], preReqs : [68], nextPerk: -1,
	  ...
	  {name : "Fire<br>Mastery", skill : 4, skillReq : 100,
	   xPos : 75, yPos : 13, conTo : [74], preReqs : [74], nextPerk: -1,
	  ...
	  {name : "Breakthrough<br>Winds", skill : 4, skillReq : 75,
	   xPos : 82, yPos : 37, conTo : [68], preReqs : [68], nextPerk: -1,
	  ...
	  {name : "Wind<br>Mastery", skill : 4, skillReq : 100,
	   xPos : 81, yPos : 13, conTo : [76], preReqs : [76], nextPerk: -1,
	  ...
	  {name : "Enchanter's Insight", skill : 5, skillReq : 20,
	   xPos : 50, yPos : 90, conTo : [78], preReqs : [78], nextPerk: -1,
	  ...
	  {name : "Soul Gem<br>Mastery", skill : 5, skillReq : 25,
	   xPos : 65, yPos : 70, conTo : [78], preReqs : [78], nextPerk: -1,
	  ...
	  {name : "Arcane<br>Experimentation", skill : 5, skillReq : 50,
	   xPos : 66, yPos : 45, conTo : [80], preReqs : [80], nextPerk: -1,
	  ...
	  {name : "Artificer's<br>Insight", skill : 5, skillReq : 75,
	   xPos : 65, yPos : 25, conTo : [81], preReqs : [81], nextPerk: -1,
	  ...
	  {name : "Elemental Lore", skill : 5, skillReq : 25,
	   xPos : 35, yPos : 60, conTo : [78], preReqs : [78], nextPerk: -1,
	  ...
	  {name : "Corpus Lore", skill : 5, skillReq : 50,
	   xPos : 35, yPos : 43, conTo : [83], preReqs : [83], nextPerk: -1,
	  ...
	  {name : "Skill Lore", skill : 5, skillReq : 75,
	   xPos : 38, yPos : 23, conTo : [84], preReqs : [84], nextPerk: -1,
	  ...
	  {name : "Weapon<br>Infusion", skill : 5, skillReq : 10,
	   xPos : 48, yPos : 72, conTo : [78], preReqs : [78], nextPerk: -1,
	  ...
	  {name : "Temporal<br>Distortion", skill : 5, skillReq : 90,
	   xPos : 54, yPos : 22, conTo : [89], preReqs : [89], nextPerk: -1,
	  ...
	  {name : "Dodge", skill : 6, skillReq : 20,
	   xPos : 62, yPos : 70, conTo : [91], preReqs : [91], nextPerk: -1,
	  ...
	  {name : "Unarmored", skill : 6, skillReq : 30,
	   xPos : 70, yPos : 50, conTo : [92], preReqs : [92], nextPerk: -1,
	   description : "Your trained reflexes allow you to dodge incoming blows when not wearing a heavy cuirass.<br>By sprinting a step or two away, you can attempt to dodge hostile attacks."},
	   //94
	  {name : "Agile Spellcasting", skill : 6, skillReq : 30,
	   xPos : 35, yPos : 60, conTo : [91], preReqs : [91], nextPerk: -1,
	  ...
	  {name : "Finesse", skill : 6, skillReq : 25,
	   xPos : 50, yPos : 61, conTo : [91], preReqs : [91], nextPerk: -1,
	  ...
	  {name : "Dexterity", skill : 6, skillReq : 50,
	   xPos : 35, yPos : 40, conTo : [95], preReqs : [95], nextPerk: -1,
	  ...
	  {name : "Wind Walker", skill : 6, skillReq : 75,
	   xPos : 38, yPos : 20, conTo : [96], preReqs : [96], nextPerk: -1,
	  ...
	  {name : "Vexing Flanker", skill : 6, skillReq : 50,
	   xPos : 68, yPos : 41, conTo : [95], preReqs : [95], nextPerk: -1,
	  ...
	  {name : "Combat<br>Training", skill : 7, skillReq : 20,
	   xPos : 70, yPos : 68, conTo : [101], preReqs : [101], nextPerk: -1,
	  ...
	  {name : "Fortitude", skill : 7, skillReq : 55,
	   xPos : 80, yPos : 52, conTo : [102], preReqs : [102], nextPerk: -1,
	  ...
	  {name : "Power of<br>the Combatant", skill : 7, skillReq : 80,
	   xPos : 78, yPos : 20, conTo : [103], preReqs : [103], nextPerk: -1,
	  ...
	  {name : "Juggernaut", skill : 7, skillReq : 100,
	   xPos : 75, yPos : 5, conTo : [104], preReqs : [104], nextPerk: -1,
	  ...
	  {name : "Combat<br>Casting", skill : 7, skillReq : 15,
	   xPos : 30, yPos : 68, conTo : [101], preReqs : [101], nextPerk: -1,
	  ...
	  {name : "Combat Trance", skill : 7, skillReq : 40,
	   xPos : 20, yPos : 52, conTo : [106], preReqs : [106], nextPerk: -1,
	  ...
	  {name : "Combat Meditation", skill : 7, skillReq : 65,
	   xPos : 22, yPos : 20, conTo : [107], preReqs : [107], nextPerk: -1,
	  ...
	  {name : "Battle Mage", skill : 7, skillReq : 95,
	   xPos : 25, yPos : 5, conTo : [108], preReqs : [108], nextPerk: -1,
	  ...
	  {name : "Relentless<br>Onslaught", skill : 7, skillReq : 10,
	   xPos : 50, yPos : 68, conTo : [101], preReqs : [101], nextPerk: -1,
	  ...
	  {name : "Toxin<br>Nullification", skill : 7, skillReq : 25,
	   xPos : 50, yPos : 52, conTo : [110], preReqs : [110], nextPerk: -1,
	  ...
	  {name : "Elemental<br>Nullification", skill : 7, skillReq : 50,
	   xPos : 50, yPos : 35, conTo : [111], preReqs : [111], nextPerk: -1,
	  ...
	  {name : "Magic<br>Nullification", skill : 7, skillReq : 75,
	   xPos : 50, yPos : 20, conTo : [112], preReqs : [112], nextPerk: -1,
	  ...
	  {name : "Apprentice<br>Illusion", skill : 8, skillReq : 20,
	   xPos : 50, yPos : 65, conTo : [114], preReqs : [114], nextPerk: -1,
	  ...
	  {name : "Empowered<br>Manipulations", skill : 8, skillReq : 20,
	   xPos : 75, yPos : 55, conTo : [114], preReqs : [114], nextPerk: -1,
	  ...
	  {name : "Delusive<br>Phantasms", skill : 8, skillReq : 15,
	   xPos : 90, yPos : 75, conTo : [114], preReqs : [114], nextPerk: -1,
	  ...
	  {name : "Acoustic<br>Manipulation", skill : 8, skillReq : 25,
	   xPos : 30, yPos : 65, conTo : [114], preReqs : [114], nextPerk: -1,
	  ...
	  {name : "Visual<br>Manipulation", skill : 8, skillReq : 30,
	   xPos : 37, yPos : 38, conTo : [114], preReqs : [114], nextPerk: -1,
	  ...
	  {name : "Otherwordly<br>Phantasms", skill : 8, skillReq : 45,
	   xPos : 88, yPos : 45, conTo : [117], preReqs : [117], nextPerk: -1,
	  ...
	  {name : "Adept<br>Illusion", skill : 8, skillReq : 40,
	   xPos : 50, yPos : 40, conTo : [115], preReqs : [115], nextPerk: -1,
	  ...
	  {name : "Pain and<br>Agony", skill : 8, skillReq : 50,
	   xPos : 65, yPos : 30, conTo : [121], preReqs : [21], nextPerk: -1,
	  ...
	  {name : "Expert<br>Illusion", skill : 8, skillReq : 60,
	   xPos : 51, yPos : 25, conTo : [121], preReqs : [121], nextPerk: -1,
	  ...
	  {name : "Master<br>Illusion", skill : 8, skillReq : 80,
	   xPos : 50, yPos : 12, conTo : [125], preReqs : [125], nextPerk: -1,
	  ...
	  {name : "Advanced<br>Lockpicking", skill : 9, skillReq : 30,
	   xPos : 55, yPos : 65, conTo : [129], preReqs : [129], nextPerk: -1,
	  ...
	  {name : "Treasure<br>Hunter", skill : 9, skillReq : 50,
	   xPos : 25, yPos : 43, conTo : [130], preReqs : [130], nextPerk: -1,
	  ...
	  {name : "Sophisticated<br>lockpicking", skill : 9, skillReq : 60,
	   xPos : 58, yPos : 45, conTo : [130], preReqs : [131], nextPerk: -1,
	  ...
	  {name : "Masterly<br>Lockpicking", skill : 9, skillReq : 90,
	   xPos : 62, yPos : 20, conTo : [132], preReqs : [132], nextPerk: -1,
	  ...
	  {name : "Ranger", skill : 10, skillReq : 15,
	   xPos : 50, yPos : 75, conTo : [134], preReqs : [134], nextPerk: -1,
	  ...
	  {name : "Hunting Stride", skill : 10, skillReq : 70,
	   xPos : 40, yPos : 50, conTo : [135], preReqs : [135], nextPerk: -1,
	  ...
	  {name : "Eagle Eye", skill : 10, skillReq : 25,
	   xPos : 30, yPos : 30, conTo : [134], preReqs : [134], nextPerk: -1,
	  ...
	  {name : "Precise Aim", skill : 10, skillReq : 20,
	   xPos : 65, yPos : 60, conTo : [134], preReqs : [134], nextPerk: -1,
	  ...
	  {name : "Marksman's Focus", skill : 10, skillReq : 50,
	   xPos : 60, yPos : 20, conTo : [137], preReqs : [137], nextPerk: -1,
	  ...
	  {name : "Rapid Reload", skill : 10, skillReq : 60,
	   xPos : 62, yPos : 25, conTo : [137], preReqs : [137], nextPerk: -1,
	  ...
	  {name : "Ammunition Specialist", skill : 10, skillReq : 55,
	   xPos : 64, yPos : 30, conTo : [137], preReqs : [137], nextPerk: -1,
	  ...
	  {name : "Quick Shot", skill : 10, skillReq : 60,
	   xPos : 66, yPos : 35, conTo : [137], preReqs : [137], nextPerk: -1,
	  ...
	  {name : "Power<br>Shot", skill : 10, skillReq : 75,
	   xPos : 32, yPos : 17, conTo : [137], preReqs : [137], nextPerk: -1,
	  ...
	  {name : "Piercing<br>Shot", skill : 10, skillReq : 45,
	   xPos : 53, yPos : 35, conTo : [138], preReqs : [138], nextPerk: -1,
	  ...
	  {name : "Penetrating Shot", skill : 10, skillReq : 80,
	   xPos : 45, yPos : 16, conTo : [144], preReqs : [144], nextPerk: -1,
	  ...
	  {name : "Weapon Mastery", skill : 11, skillReq : 35,
	   xPos : 50, yPos : 90, conTo : [147], preReqs : [147], nextPerk: -1,
	  ...
	  {name : "Flurry", skill : 11, skillReq : 25,
	   xPos : 85, yPos : 78, conTo : [148], preReqs : [148], nextPerk: 150,
	  ...
	  {name : "Penetrating Strikes", skill : 11, skillReq : 15,
	   xPos : 50, yPos : 65, conTo : [147], preReqs : [147], nextPerk: -1,
	  ...
	  {name : "Dagger<br>Focus", skill : 11, skillReq : 25,
	   xPos : 25, yPos : 50, conTo : [152], preReqs : [152], nextPerk: 154,
	  ...
	  {name : "War Axe<br>Focus", skill : 11, skillReq : 0,
	   xPos : 35, yPos : 50, conTo : [152], preReqs : [152], nextPerk: 157,
	  ...
	  {name : "Mace<br>Focus", skill : 11, skillReq : 25,
	   xPos : 65, yPos : 50, conTo : [152], preReqs : [152], nextPerk: 160,
	  ...
	  {name : "Sword<br>Focus", skill : 11, skillReq : 25,
	   xPos : 75, yPos : 50, conTo : [152], preReqs : [152], nextPerk: 163,
	  ...
	  {name : "Powerful<br>Strike", skill : 11, skillReq : 50,
	   xPos : 42, yPos : 40, conTo : [152], preReqs : [152], nextPerk: -1,
	  ...
	  {name : "Powerful<br>Charge", skill : 11, skillReq : 50,
	   xPos : 58, yPos : 40, conTo : [152], preReqs : [152], nextPerk: -1,
	  ...
	  {name : "Nimble Fingers", skill : 12, skillReq : 40,
	   xPos : 30, yPos : 90, conTo : [168], preReqs : [168], nextPerk: -1,
	  ...
	  {name : "Akimbo Attacks", skill : 12, skillReq : 30,
	   xPos : 27, yPos : 70, conTo : [168], preReqs : [168], nextPerk: -1,
	  ...
	  {name : "Precise<br>Strikes", skill : 12, skillReq : 50,
	   xPos : 32, yPos : 37, conTo : [170], preReqs : [170], nextPerk: 172,
	  ...
	  {name : "Akimbo<br>Power Attacks", skill : 12, skillReq : 70,
	   xPos : 20, yPos : 43, conTo : [170], preReqs : [170], nextPerk: -1,
	  ...
	  {name : "Dual Savagery", skill : 12, skillReq : 90,
	   xPos : 23, yPos : 20, conTo : [173], preReqs : [173], nextPerk: -1,
	  ...
	  {name : "Cutpurse", skill : 12, skillReq : 25,
	   xPos : 35, yPos : 67, conTo : [168], preReqs : [168], nextPerk: -1,
	  ...
	  {name : "Nightly<br>Thief", skill : 12, skillReq : 50,
	   xPos : 41, yPos : 50, conTo : [175], preReqs : [175], nextPerk: -1,
	  ...
	  {name : "Misdirection", skill : 12, skillReq : 70,
	   xPos : 43, yPos : 23, conTo : [176], preReqs : [176], nextPerk: -1,
	  ...
	  {name : "Perfected Art", skill : 12, skillReq : 100,
	   xPos : 45, yPos : 5, conTo : [177], preReqs : [177], nextPerk: -1,
	  ...
	  {name : "Brawling", skill : 12, skillReq : 15,
	   xPos : 50, yPos : 69, conTo : [168], preReqs : [168], nextPerk: -1,
	  ...
	  {name : "Boxing<br>Focus", skill : 12, skillReq : 25,
	   xPos : 52, yPos : 50, conTo : [179], preReqs : [179], nextPerk: 181,
	  ...
	  {name : "Grappling<br>Focus", skill : 12, skillReq : 25,
	   xPos : 60, yPos : 43, conTo : [179], preReqs : [179], nextPerk: 184,
	  ...
	  {name : "Fast Hands", skill : 12, skillReq : 40,
	   xPos : 75, yPos : 70, conTo : [168], preReqs : [168], nextPerk: 187,
	  ...
	  {name : "Benefactor's<br>Insight", skill : 13, skillReq : 20,
	   xPos : 30, yPos : 65, conTo : [188], preReqs : [188], nextPerk: -1,
	  ...
	  {name : "Restorative<br>Expertise", skill : 13, skillReq : 30,
	   xPos : 15, yPos : 68, conTo : [188], preReqs : [188], nextPerk: -1,
	  ...
	  {name : "Apprentice<br>Restoration", skill : 13, skillReq : 25,
	   xPos : 55, yPos : 75, conTo : [188], preReqs : [188], nextPerk: -1,
	  ...
	  {name : "Respite", skill : 13, skillReq : 60,
	   xPos : 17, yPos : 30, conTo : [190], preReqs : [190], nextPerk: -1,
	  ...
	  {name : "Power of Life", skill : 13, skillReq : 75,
	   xPos : 20, yPos : 8, conTo : [192], preReqs : [192], nextPerk: -1,
	  ...
	  {name : "Solar<br>Dominance", skill : 13, skillReq : 35,
	   xPos : 75, yPos : 50, conTo : [191], preReqs : [191], nextPerk: -1,
	  ...
	  {name : "Mysticism", skill : 13, skillReq : 75,
	   xPos : 60, yPos : 30, conTo : [194], preReqs : [194], nextPerk: -1,
	  ...
	  {name : "Magnus' Comprehension", skill : 13, skillReq : 70,
	   xPos : 77, yPos : 20, conTo : [194], preReqs : [194], nextPerk: -1,
	  ...
	  {name : "Adept<br>Restoration", skill : 13, skillReq : 50,
	   xPos : 40, yPos : 35, conTo : [191], preReqs : [191], nextPerk: -1,
	  ...
	  {name : "Expert<br>Restoration", skill : 13, skillReq : 75,
	   xPos : 42, yPos : 20, conTo : [197], preReqs : [197], nextPerk: -1,
	  ...
	  {name : "Master<br>Restoration", skill : 13, skillReq : 100,
	   xPos : 35, yPos : 8, conTo : [198], preReqs : [198], nextPerk: -1,
	  ...
	  {name : "Ward Mastery", skill : 13, skillReq : 90,
	   xPos : 60, yPos : 5, conTo : [198], preReqs : [198], nextPerk: -1,
	  ...
	  {name : "Advanced<br>Blacksmithing", skill : 14, skillReq : 50,
	   xPos : 50, yPos : 70, conTo : [201], preReqs : [201], nextPerk: -1,
	  ...
	  {name : "Arcane<br>Craftsmanship", skill : 14, skillReq : 60,
	   xPos : 37, yPos : 53, conTo : [202], preReqs : [202], nextPerk: -1,
	  ...
	  {name : "Legendary<br>Blacksmithing", skill : 14, skillReq : 100,
	   xPos : 63, yPos : 53, conTo : [202], preReqs : [202], nextPerk: -1,
	  ...
	  {name : "Advanced<br>Light Armors", skill : 14, skillReq : 25,
	   xPos : 37, yPos : 77, conTo : [201], preReqs : [201], nextPerk: -1,
	  ...
	  {name : "Elven<br>Smithing", skill : 14, skillReq : 40,
	   xPos : 20, yPos : 67, conTo : [201], preReqs : [201], nextPerk: -1,
	  ...
	  {name : "Morrowind<br>Smithing", skill : 14, skillReq : 60,
	   xPos : 5, yPos : 63, conTo : [201], preReqs : [201], nextPerk: -1,
	  ...
	  {name : "Orcish<br>Smithing", skill : 14, skillReq : 45,
	   xPos : 60, yPos : 77, conTo : [201], preReqs : [201], nextPerk: -1,
	  ...
	  {name : "Dwarven<br>Smithing", skill : 14, skillReq : 55,
	   xPos : 75, yPos : 67, conTo : [201], preReqs : [201], nextPerk: -1,
	  ...
	  {name : "Nordic<br>Smithing", skill : 14, skillReq : 65,
	   xPos : 95, yPos : 63, conTo : [201], preReqs : [201], nextPerk: -1,
	  ...
	  {name : "Glass<br>Smithing", skill : 14, skillReq : 75,
	   xPos : 29, yPos : 40, conTo : [205,206,207], preReqs : [201], nextPerk: -1,
	  ...
	  {name : "Daedric Smithing", skill : 14, skillReq : 100,
	   xPos : 71, yPos : 20, conTo : [212], preReqs : [212], nextPerk: -1,
	  ...
	  {name : "Stalhrim<br>Smithing", skill : 14, skillReq : 85,
	   xPos : 50, yPos : 43, conTo : [211,212], preReqs : [201], nextPerk: -1,
	  ...
	  {name : "Draconic<br>Smithing", skill : 14, skillReq : 100,
	   xPos : 50, yPos : 35, conTo : [211,212], preReqs : [201], nextPerk: -1,
	  ...
	  {name : "Stealth", skill : 15, skillReq : 0,
	   ...
	   //217
	  {name : "Stealth", skill : 15, skillReq : 0,
	   xPos : 50, yPos : 90, conTo : [216], preReqs : [216], nextPerk: -1,
	  ...
	  {name : "Anatomical Lore", skill : 15, skillReq : 50,
	   xPos : 63, yPos : 50, conTo : [219], preReqs : [219], nextPerk: -1,
	  ...
	  {name : "Advanced<br>Anatomical Lore", skill : 15, skillReq : 75,
	   xPos : 55, yPos : 40, conTo : [220], preReqs : [220], nextPerk: -1,
	  ...
	  {name : "Light<br>Steps", skill : 15, skillReq : 40,
	   xPos : 42, yPos : 40, conTo : [218], preReqs : [218], nextPerk: -1,
	  ...
	  {name : "Acrobatics", skill : 15, skillReq : 75,
	   xPos : 50, yPos : 32, conTo : [222], preReqs : [222], nextPerk: -1,
	  ...
	  {name : "Shadowrunner", skill : 15, skillReq : 100,
	   xPos : 65, yPos : 20, conTo : [223], preReqs : [223], nextPerk: -1,
	  ...
	  {name : "Haggling", skill : 16, skillReq : 40,
	   xPos : 25, yPos : 90, conTo : [225], preReqs : [225], nextPerk: -1,
	  ...
	  {name : "Merchant", skill : 16, skillReq : 60,
	   xPos : 22, yPos : 50, conTo : [225], preReqs : [225], nextPerk: -1,
	  ...
	  {name : "Silver Tongue", skill : 16, skillReq : 25,
	   xPos : 8, yPos : 70, conTo : [225], preReqs : [225], nextPerk: -1,
	  ...
	  {name : "Fencing", skill : 16, skillReq : 100,
	   xPos : 33, yPos : 30, conTo : [227], preReqs : [227], nextPerk: -1,
	  ...
	  {name : "Leadership", skill : 16, skillReq : 75,
	   xPos : 23, yPos : 28, conTo : [228], preReqs : [228], nextPerk: -1,
	  ...
	  {name : "Masquerade", skill : 16, skillReq : 50,
	   xPos : 20, yPos : 20, conTo : [228], preReqs : [228], nextPerk: 232,
	  ...
	  {name : "Destructive Urge", skill : 16, skillReq : 0,
	   xPos : 55, yPos : 80, conTo : [233], preReqs : [233], nextPerk: -1,
	  ...
	  {name : "Indomitable Force", skill : 16, skillReq : 0,
	   xPos : 53, yPos : 60, conTo : [233], preReqs : [233], nextPerk: -1,
	   ...
	   xPos : 57, yPos : 35, conTo : [233], preReqs : [233], nextPerk: -1,
	   ...
	   xPos : 60, yPos : 25, conTo : [233], preReqs : [233], nextPerk: -1,
	   ...
	   xPos : 50, yPos : 90, conTo : [238], preReqs : [238], nextPerk: -1,
	   ...
	   xPos : 50, yPos : 65, conTo : [238], preReqs : [238], nextPerk: -1,
	   ...
	   xPos : 38, yPos : 55, conTo : [240], preReqs : [240], nextPerk: 242,
	   ...
	   xPos : 62, yPos : 55, conTo : [240], preReqs : [240], nextPerk: 245,
	   ...
	   xPos : 62, yPos : 75, conTo : [240], preReqs : [240], nextPerk: 248,
	   ...
	   xPos : 38, yPos : 75, conTo : [240], preReqs : [240], nextPerk: 251,
	   ...
	   xPos : 56, yPos : 40, conTo : [240], preReqs : [240], nextPerk: -1,
	   ...
	   xPos : 44, yPos : 40, conTo : [240], preReqs : [240], nextPerk: -1,
	   ...
	   xPos : 50, yPos : 10, conTo : [255], preReqs : [255], nextPerk: -1,
	   ...
	   xPos : 50, yPos : 5, conTo : [256], preReqs : [256], nextPerk: -1,
